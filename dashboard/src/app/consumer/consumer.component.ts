...
export class ConsumerComponent implements OnInit {
  ...
  openWorkersCountModal = (groupId: string, consumerName: string) => {
    ...
    modalRef.result.then((newWorkersCount: number) => {
      this.gateway
        .changeWorkers(groupId, consumerName, newWorkersCount)
  ...
  openResetModal = (groupId: string, consumerName: string, topic: string) => {
    ...
    modalRef.result.then(() => {
      this.gateway
        .resetConsumerTopic(groupId, consumerName, topic)
  ...
  openPauseModal = (groupId: string, consumerName: string, topic: string) => {
    ...
    modalRef.result.then(() => {
      this.gateway
        .pauseConsumerTopic(groupId, consumerName, topic)
  ...
  openStopModal = (groupId: string, consumerName: string) => {
    ...
    modalRef.result.then(() => {
      this.gateway.stopConsumer(groupId, consumerName)
  ...
  openResumeModal = (groupId: string, consumerName: string, topic: string) => {
    ...
    modalRef.result.then(() => {
      this.gateway
        .resumeConsumerTopic(groupId, consumerName, topic)
  ...
  openRewindModal = (groupId: string, consumerName: string, topic: string) => {
    ...
    modalRef.result.then((dateString: string) => {
      ...
      this.gateway.rewindConsumerTopic(groupId, consumerName, topic, timestamp)
